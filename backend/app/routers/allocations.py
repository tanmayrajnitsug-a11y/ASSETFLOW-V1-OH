...
def allocate_asset(
    ...
    return allocation_service.allocate_asset(db=db, allocation_in=allocation_in)
...
def return_asset(
    ...
    return allocation_service.return_asset(db=db, allocation_id=allocation_id)
...
def create_transfer(
    ...
    return allocation_service.create_transfer(db=db, transfer_in=transfer_in)
...
def read_transfers(
    ...
    return allocation_service.get_transfers(
...
def complete_transfer(
    ...
    return allocation_service.complete_transfer(db=db, transfer_id=transfer_id)
